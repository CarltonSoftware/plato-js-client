...
/**
 * Property branding price fixed price object
 * 
 */

function PropertyBrandingPriceFixed(id) {
...
PropertyBrandingPriceFixed.prototype = new SingleEntity();
PropertyBrandingPriceFixed.prototype.toArray = function() {
  return {
    type: 'Fixed',
...
PropertyBrandingPriceFixed.prototype.getDayPrice = function(day, date) {
  var dayPrice;
  var price = '-';
  if (day < 7) {
...
module.exports = PropertyBrandingPriceFixed;